...
def firstCases():
    ...
    sql_porto= "select distinct(t.taxi), t.ts from tracks as t, cont_aad_caop2018 as f where f.concelho = 'LISBOA' and st_contains(f.proj_boundary,ST_StartPoint(t.proj_track)) order by t.ts  limit 10" 
    ...
    sql_lisboa =  "select distinct(t.taxi), t.ts from tracks as t, cont_aad_caop2018 as f where f.concelho = 'PORTO' and st_contains(f.proj_boundary,ST_StartPoint(t.proj_track)) order by t.ts limit 10"
